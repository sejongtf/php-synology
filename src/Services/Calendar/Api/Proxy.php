 ...
 * 생성기가 다시 건드리지 않는다.
 *
 * @method mixed cal_list(array $params = [])
 * @method mixed task_create(array $params = [])
 * @method mixed task_create_ics(array $params = [])
 * @method mixed task_list(array $params = [])
 * @method mixed task_update(array $params = [])
 */
class Proxy extends Api
{
    const API_NAME = 'SYNO.Cal.Proxy';
