 ...
 * 생성기가 다시 건드리지 않는다.
 *
 * @method mixed doc_convert(array $params = [])
 * @method mixed get(array $params = [])
 * @method mixed og(array $params = [])
 * @method mixed thumbnail(array $params = [])
 * @method mixed video_link(array $params = [])
 */
class PostFile extends Api
{
    const API_NAME = 'SYNO.Chat.Post.File';
